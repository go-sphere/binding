...
const (
	...
	BindingLocation_BINDING_LOCATION_FORM        BindingLocation = 4 // Indicates that the binding is for form parameters.
	BindingLocation_BINDING_LOCATION_HEADER      BindingLocation = 5 // Indicates that the binding is for header parameters.
)
